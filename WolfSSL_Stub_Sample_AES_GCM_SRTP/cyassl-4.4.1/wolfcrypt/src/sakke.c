 ...
 * key.
 *
 * Flags that the p, q and a are avaialble so it isn't loaded multiple times.
 *
 * @param  [in]  key  SAKKE key.
 * @return  0 on success.
 * @return  MEMORY_E when dynamic memory allocation fails.
 ...
 *
 * Flags that the g is avaialble so it isn't loaded multiple times.
 *
 * @param  [in]  key  SAKKE key.
 * @return  0 on success.
 * @return  MEMORY_E when dynamic memory allocation fails.
 ...
 * @parma  [in]  set    1 when mu is set and 0 when it needs to be calucaluted.
 * @return  0 on success.
 * @return  MEMORY_E when dynamic memory allocation fails.
 * @return  Other -ve value on internal failure.
 */
...
/*
 * Multuply a by b modulo m in Montgomery.
 *
...
/**
 * Get the elliptic curve point I - a parial calculation for point R.
 *
 * RFC 6508, Section 6.2.1, Step 3.\n
 * RFC 6508, Section 6.2.2, Step 5.\n
 * I = [b]P + Z_S
...
/**
 * Set the elliptic curve point I - a parial calucation for point R - and the
 ...
 * @parma  [in,out]  len    On in, the size of table buffer in bytes.
