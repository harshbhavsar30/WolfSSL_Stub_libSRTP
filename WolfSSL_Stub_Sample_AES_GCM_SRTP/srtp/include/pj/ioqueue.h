...
#   define PJ_IOQUEUE_MAX_EVENTS_IN_SINGLE_POLL     (48)    /* Code added for Initial Volley Clipping */
#endif
...
//kodiak changes begin
/**
 * When this flag is specified in ioqueue's recv() operations,
 * the ioqueue will always mark the operation as secured read.
 */
#define PJ_IOQUEUE_SECURE_READ_OP	    ((pj_uint32_t)1 << (pj_uint32_t)15)
