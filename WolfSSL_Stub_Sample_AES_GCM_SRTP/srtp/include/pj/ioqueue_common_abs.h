 ...
 * to the ioqueue. 
 */
/* START - [64_BIT_PORTING : -Wimplicit-function-declaration]  generic*/
#ifndef __IOQUEUE_COMMON_ABS_H__
#define __IOQUEUE_COMMON_ABS_H__

/* END   - [64_BIT_PORTING : -Wimplicit-function-declaration]  */
...
void ioqueue_add_to_set( pj_ioqueue_t *ioqueue,
                                pj_ioqueue_key_t *key,
                                enum ioqueue_event_type event_type );
void ioqueue_remove_from_set( pj_ioqueue_t *ioqueue,
                                     pj_ioqueue_key_t *key, 
                                     enum ioqueue_event_type event_type);

#endif //__IOQUEUE_COMMON_ABS_H__