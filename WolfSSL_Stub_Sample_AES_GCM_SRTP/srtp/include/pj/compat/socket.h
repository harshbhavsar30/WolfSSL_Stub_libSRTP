...
#if	defined (POC_CDE_BREW) && POC_CDE_BREW != 0
...
#elif defined(PJ_MTK) && PJ_MTK != 0
#  define OSERR_EWOULDBLOCK    -1
#  define OSERR_EINPROGRESS    -1
#  define OSERR_ECONNRESET     -1
#  define OSERR_ENOTCONN       -1
#elif (defined(PJ_RTKE) && PJ_RTKE != 0) || (defined(PJ_THREADX) && PJ_THREADX!=0)
#  define FD_SETSIZE 	       SOCKET_FD_SETSIZE
#  define AF_INET 	       SOCK_AF_INET
#  define OSERR_EWOULDBLOCK    SOCK_OSERR_EWOULDBLOCK
#  define OSERR_EINPROGRESS    SOCK_OSERR_EINPROGRESS
#  define OSERR_ECONNRESET     SOCK_OSERR_ECONNRESET
#  define OSERR_ENOTCONN       SOCK_OSERR_ENOTCONN
