...
#elif defined(PJ_RTKE) && PJ_RTKE!= 0
#include "pj/pj_shp_osal.h"
    typedef int pj_os_err_type;
#   define pj_get_native_os_error()	    ShpGetLastError()
#   define pj_get_native_netos_error()	    ShpGetLastError()

#elif defined(PJ_THREADX) && PJ_THREADX!= 0
#include "pj/pj_threadx.h"
    typedef int pj_os_err_type;
#   define pj_get_native_os_error()	    UtaGetLastError()
#   define pj_get_native_netos_error()	    UtaGetLastError()
