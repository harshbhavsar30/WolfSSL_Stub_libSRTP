...
#elif (defined(PJ_RTKE) && PJ_RTKE != 0) || (defined(PJ_THREADX) && PJ_THREADX!=0) || (defined(POC_CDE_BREW) && POC_CDE_BREW!=0) 
...
#define RAND_MAX 100
#else
#define RAND_MAX KN_RAND_MAX
#endif
#ifdef POC_CDE_BREW
#  define platform_srand    psptt_srand
#  define platform_rand     psptt_rand
#else
#  define platform_srand    KN_SRAND
#  define platform_rand     KN_RAND
#endif
#else
