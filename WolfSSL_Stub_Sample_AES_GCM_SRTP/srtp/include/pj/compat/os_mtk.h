/* $Id: os_mtk.h,v 1.1.2.1 2011-07-04 13:38:24 lnaveen Exp $ */
/* 
 ...
 */
#ifndef __PJ_COMPAT_OS_MTK_H__
#define __PJ_COMPAT_OS_MTK_H__

/**
 * @file os_mtk.h
 * @brief Describes MTK operating system specifics.
 */
 ...
 */
#define PJ_BLOCKING_ERROR_VAL       -2 
						//changed to	SOC_WOULDBLOCK from EWOULDBLOCK

/* This value specifies the value set in errno by the OS when a non-blocking
 * socket connect() can not get connected immediately.
 */
#define PJ_BLOCKING_CONNECT_ERROR_VAL   -2 
