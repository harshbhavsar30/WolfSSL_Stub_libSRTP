...
#ifdef POC_CDE_BREW
typedef PSPTT_SIZE_T pj_size_t;
#else
...
#else
#ifdef POC_CDE_BREW
typedef unsigned long pj_sock_t;
#else
 ...
 */
#define PSPTT_MAX_PATH_LENGTH 256
