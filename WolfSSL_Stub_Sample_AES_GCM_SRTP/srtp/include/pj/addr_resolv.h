...
PJ_BEGIN_DECL
#ifdef POC_CDE_BREW
#define PJ_BREW_MAX_ADDR_RESOLUTION 4
#endif
/**
...
#ifdef POC_CDE_BREW //INT104207
	unsigned long h_addr_list[PJ_BREW_MAX_ADDR_RESOLUTION];
#else
...
#if defined(KN_GETADDR_TIMEOUT)
#define PJ_GETADDRINFO_TIMEOUT_MS	30000
PJ_DECL(pj_status_t) pj_getaddrinfo_timeout(int af, const pj_str_t *name, unsigned *count, pj_addrinfo ai[], int timeout);
#endif
