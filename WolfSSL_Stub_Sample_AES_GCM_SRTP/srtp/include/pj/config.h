/* $Id: config.h 5744 2018-02-21 02:58:39Z ming $ */
/* 
...
#   undef PJ_MTK
#   define PJ_MTK	    1
#   include <pj/compat/os_mtk.h>

#elif defined(PJ_RTKE)
    /*
     * RTKE
     */
#   undef PJ_RTKE
#   define PJ_RTKE	    1
#   include <pj/compat/os_rtke.h>

#elif defined(PJ_THREADX)
    /*
     * THREADX
     */
#   undef PJ_THREADX
#   define PJ_THREADX    1
#   include <pj/compat/os_threadx.h>
#elif defined(PJ_BREW) || defined AEE_SIMULATOR || defined POC_CDE_BREW
#include <pj/compat/os_brew.h>
 ...
 * Default: 1.
 */
#if !defined PJ_HAS_FLOATING_POINT && !defined POC_CDE_BREW
...
/**
 * Separated Embedded OS and Open OS for configuration reasons.
 * This is the maximum number of IOQUEUE Keys used in IOQUEUE
 */
#if defined(PJ_RTKE) || defined(PJ_THREADX)
#define KN_MAX_IOQUEUE_SIZE	40
#else
#define KN_MAX_IOQUEUE_SIZE	PJ_IOQUEUE_MAX_HANDLES//40
#endif 
 ...
 * Default: 500 msec.
 */
 // KSantosh-MS-CHANGES - Changed the free time to get closing keys to free list, Need to monitor the behaviour and get the right free time
#ifndef PJ_IOQUEUE_KEY_FREE_DELAY
#   define PJ_IOQUEUE_KEY_FREE_DELAY	200//500
#endif
