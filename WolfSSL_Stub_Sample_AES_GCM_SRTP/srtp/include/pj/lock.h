...
#define pj_lock_acquire(mutex) pj_lock_acquire_debug(mutex, __FILE__, __LINE__)
PJ_DECL(pj_status_t) pj_lock_acquire_debug( pj_lock_t *lock, char *fileName, int lineNum );
#else
